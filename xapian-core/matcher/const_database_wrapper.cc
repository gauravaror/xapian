...
Xapian::termcount
ConstDatabaseWrapper::get_bigramdoclength(Xapian::docid did) const
{
    return realdb->get_bigramdoclength(did);
}

Xapian::termcount
ConstDatabaseWrapper::get_nouniqbigram(Xapian::docid did) const
{
	return realdb->get_nouniqbigram(did);
}
