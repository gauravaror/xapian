...
#ifndef XAPIAN_INCLUDED_BRASS_TERMLIST_H
#define XAPIAN_INCLUDED_BRASS_TERMLIST_H
...
/// A TermList in a brass database.
class BrassTermList : public TermList {
    /// Don't allow assignment.
    void operator=(const BrassTermList &);
  ...
  public:
     ...
     *
     *  For a BrassTermList, this value will always be exact.
     */
     ...
     *
     *  @return Always returns 0 for a BrassTermList.
     */
    TermList * next();
...
#endif // XAPIAN_INCLUDED_BRASS_TERMLIST_H
